...
function generateCell(gx, gy) {
  ...
  // E(0.32~0.40): 밀집 소형 기둥  P(0.40~0.46): 형광등 방 (4등, 넓은 통로)
  ...
  const isLargeOpen = zt >= 0.40 && zt < 0.46; // P방도 넓은 통로 유지
  ...
  // ── P: 형광등 방 (6%) — 빈 공간, 천장에 4개 형광등, 넓은 통로 ──
  if (zt < 0.46) return 0;
  ...
  // ── K: ㄴ/ㄱ 혼합 방 (5%) — 경계 여백 2칸 확보, 방향 혼합
  if (zt < 0.81) {
  ...
  // ── L: ㄱ/ㄴ 혼합 방 (5%) — 경계 여백 2칸 확보, 방향 혼합
  if (zt < 0.86) {
